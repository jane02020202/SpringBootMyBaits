...
public class MovieService implements IMovieService {
    ...
    public int collectMovieRank() throws Exception {
        ...
        // 사이트 접속(http프로토롤만 가능, https 프로토콜은 보안상 안됨)
        ...
        while (movie_rank.hasNext()) {
            ...
            // 영화 순위(trim 함수 추가 이유 : trim 함수는 글자의 앞뒤 공백 삭제 역할을 수행하고, 데이터 수집시,
            // 홈페이지 개발자들이 앞뒤 공백을 집어넣을 수 있어서 추가)
    ...
    /**
     * 수집된 영화 정보 조회하기
     * (해당 구현부 코드가 담긴 슬라이드는 아직 안 보내주셔서, Mapper 호출 위주의 기본형으로 작성했습니다.
     *  정확한 원본 슬라이드 있으면 보내주세요 — 그대로 교체해드릴게요.)
     */
    @Override
